...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="container-fluid">
            ...
            <!-- Start Page Content -->
            <!-- ============================================================== -->
            <form id="signature-form" action="{{ route('admin.companies.store') }}" method="post"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="branches_count">
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="buildings_count">
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="units_count">
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <div class="form-group">
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="monthly_subscription_building">
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="monthly_subscription_units">
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="monthly_subscription_branches">
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <div class="form-group">
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control creation_date" name="creation_date">
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <div class="form-group">
                            ...
                            {{-- <div class="col-md-6 col-lg-4 col-xl-3">
                                <div class="form-group">
                                    <label for="name" class="title-color">{{ __('companies.company_code') }}<span
                                            class="text-danger"> *</span>
                                    </label>
                ...
                {{--
                            <div class="col-md-6 col-lg-4 col-xl-2">
                                <div class="form-group">
                                    ...
                                    <select class="js-select2-custom form-control" name="fax_dail_code">
                                        <option value="{{ old('fax_dail_code') }}" selected>{{ __('general.select') }}
                                        </option>
                                        @foreach ($dail_code_main as $item_dail_code_two)
                                            <option value="{{ '+' . $item_dail_code_two->dial_code }}">
                                                {{ '+' . $item_dail_code_two->dial_code }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <div class="form-group">
                                    <label for="name"
                                        class="title-color">{{ __('companies.financial_year_start_ith') }}</label>
                                    <input type="date" class="form-control" id="financial_year_start">
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <div class="form-group">
                                    <label for="name"
                                        class="title-color">{{ __('companies.book_begining_with') }}</label>
                                    <input type="text" class="form-control" id="booking_beging_with">
                                </div>
                            </div>
                            -- }}
                            <div class="col-md-6 col-lg-4 col-xl-3">
                            ...
                            <div class="col-lg-6 mb-4 mb-lg-0">
                                <div class="form-group">
                                    <label for="exampleFirstName"
                                        class="title-color d-flex gap-1 align-items-center">{{ __('companies.address1') }}</label>
                                    <input type="text" class="form-control form-control-user" name="address1">
                                </div>
                                <div class="form-group">
                                    <label for="exampleLastName"
                                        class="title-color d-flex gap-1 align-items-center">{{ __('companies.address2') }}</label>
                                    <input type="text" class="form-control form-control-user" name="address2">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPhone"
                                        class="title-color d-flex gap-1 align-items-center">{{ __('companies.address3') }}</label>
                                    <input type="text" class="form-control form-control-user" name="address3">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-file text-left">
                                        ...
                                        <label class="custom-file-label"
                                            for="customFileUpload">{{ __('general.upload_image') }}</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card mt-3">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-user" name="countryCode"
                                        disabled>
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-user" disabled name="region"
                                        required>
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-user" disabled name="currency"
                                        required>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-user" disabled name="symbol"
                                        required>
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <div class="form-group">
                                    ...
                                    <input disabled type="text" name="decimals" class="form-control">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <div class="form-group">
                                    <label class="title-color">{{ __('companies.city') }}</label>
                                    <input type="text" name="city" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <div class="form-group">
                                    <label class="title-color">{{ __('companies.location') }}</label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-2">
                                <div class="form-group">
                                    ...
                                    <select class="js-select2-custom form-control" name="mobile_dail_code">
                                        <option value="{{ old('mobile_dail_code') }}" selected>{{ __('general.select') }}
                                        </option>
                                        @foreach ($dail_code_main as $item_dail_code_three)
                                            <option value="{{ '+' . $item_dail_code_three->dial_code }}">
                                                {{ '+' . $item_dail_code_three->dial_code }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-2">
                                <div class="form-group">
                                    <label class="title-color">{{ __('companies.mobile') }}</label>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <div class="form-group">
                                    ...
                                    <select class="js-select2-custom form-control" name="tax_type" required>
                                        <option value="2" selected>{{ __('general.no') }}</option>
                                        <option value="1">{{ __('general.yes') }}</option>
                                        {{-- <option value="exempted">{{ __('companies.exempted') }}</option>
                                    <option value="non_taxable">{{ __('companies.non_taxable') }}</option>
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-3 d-none tax_status_html">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="tax_reg_date" class="form-control"
                                        id="tax_registration_date">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-3 mt-5 d-none tax_status_html">
                                <div class="form-group">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-6 mb-4 mb-lg-0">
                                <div class="form-group">
                                    <a id="add-signature-pad"
                                        class="btn btn--primary mb-2">{{ __('companies.add_signature') }}</a>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <center>
                                        <img class="upload-img-view" id="viewerSeal" alt="banner image"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-file text-left">
                                        <input type="file" name="seal" id="customFileUploadSeal"
                                            ...
                                            accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                        <label class="custom-file-label"
                                            for="customFileUploadSeal">{{ __('general.upload_image') }}</label>
                                    </div>
                                </div>
                            </div>
                        </div>

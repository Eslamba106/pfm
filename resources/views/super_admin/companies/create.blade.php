    ...
    <div class="content container-fluid">
        ...
        <div class="container-fluid">
            ...
            <form id="signature-form" action="{{ route('admin.companies.store') }}" method="post"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <div class="form-group">
                                    <label for="company_id" class="title-color">{{ __('companies.company_id') }} <span
                                            class="text-danger"> *</span></label>
                                    <input type="text" class="form-control" required name="company_id" value="{{ company_id() }}" >
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <div class="form-group">
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="building_count">
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <div class="form-group">
                ...
                {{-- <button type="button" class="btn btn--primary form-control" onclick="add_service()">{{ __('property_transactions.add_other_services') }}</button>
                <div class="card-body mt-3" id="main_service_content">

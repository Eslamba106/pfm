...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}"
    @if (session()->has('locale') && session()->get('locale') == 'ar') dir="rtl" lang="ar" @else dir="ltr" lang="en" @endif
...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/back-end/css/toastr.cs') }}s">
</head>

<body class="footer-offset">
    <!-- Builder -->
    @include('super_admin.layouts.partials._front-settings')
    <!-- End Builder -->
    {{-- loader --}}
    {{-- <div class="row">
    ...
    @include('super_admin.layouts.partials._header')
    @include('super_admin.layouts.partials._side-bar')
    ...
    <main id="content" role="main" class="main pointer-event">
        ...
        <!-- Footer -->
        @include('super_admin.layouts.partials._footer')
        <!-- End Footer -->

        @include('super_admin.layouts.partials._modals')

        {{-- Toggle Modal --}}
        @include('super_admin.layouts.partials._toggle-modal')
    </main>
    <!-- ========== END MAIN CONTENT ========== -->

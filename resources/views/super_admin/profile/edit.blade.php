...
@section('content')
    ...
    <div class="content container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                <form action="{{ route('admin_settings.update', [$admin->id]) }}" method="post"
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="  form-group">
                                        ...
                                        <input type="name" class="form-control" name="name" 
                                            value="{{ $admin->name }}"
                                            placeholder="{{ ui_change('enter_new_name') }}"
                                ...
                                <div class="col-sm-6">
                                    <div class="  form-group">
                                        ...
                                        <input type="password" value="{{ $admin->my_pass }}" class="js-pwstrength form-control" name="password"
                                            id="newPassword" placeholder="{{ ui_change('enter_new_password') }}"

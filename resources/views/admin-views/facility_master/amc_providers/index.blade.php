...
@section('title', ui_change('amc_provider','facility_master') )
@push('css_or_js')
    ...
    <div class="content container-fluid">
        ...
        <div class="mb-3">
            <h2 class="h1 mb-0 d-flex gap-2">
                {{-- <img width="60" src="{{ asset('/assets/back-end/img/amc_provider.jpg') }}" alt=""> --}}
                {{ ui_change('amc_provider','facility_master')  }}
            </h2>
        </div>
        <!-- End Page Title -->
            ...
            <div class="col-md-12 mb-3">
                <div class="card">
                    <div class="card-header">
                        {{ ui_change('add_new_amc_provider','facility_master')  }}
                    </div>
                    <div class="card-body" style="text-align: {{ Session::get('locale') === 'ar' ? 'right' : 'left' }};">
                        <form action="{{ route('amc_provider.store') }}" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-md-6 col-lg-4 col-xl-3">
                                    <div class="form-group">
                                        <label for="code" class="title-color">{{ ui_change('code','facility_master') }}
                                        </label>
                                ...
                                <div class="col-md-6 col-lg-4 col-xl-3">
                                    <div class="form-group">
                                        <label for="name" class="title-color">{{ ui_change('name','facility_master')  }}
                                        </label>
                                ...
                                <div class="col-md-2 col-lg-1 col-xl-1">
                                    <div class="form-group">
                                        <label for="dail_code_contact_no" class="title-color">{{ ui_change('dail_code','facility_master')  }}
                                        </label>
                                ...
                                <div class="col-md-2 col-lg-1 col-xl-1">
                                    <div class="form-group">
                                        <label for="dail_code_whatsapp_no" class="title-color">{{ ui_change('dail_code','facility_master')  }}
                                        </label>
                                ...
                                <div class="col-md-4 col-lg-2 col-xl-2">
                                    <div class="form-group">
                                        <label for="whatsapp_no" class="title-color">{{ ui_change('whatsapp_no','facility_master') }}
                                        </label>
                                ...
                                <div class="col-md-6 col-lg-4 col-xl-3">
                                    <div class="form-group">
                                        <label for="address1"
                                            class="title-color">{{ ui_change('address1','facility_master') }}
                                        </label>
                                ...
                                <div class="col-md-6 col-lg-4 col-xl-3">
                                    <div class="form-group">
                                        <label for="address2"
                                            class="title-color">{{ ui_change('address2','facility_master')  }}
                                        </label>
                                ...
                                <div class="col-md-6 col-lg-4 col-xl-3">
                                    <div class="form-group"> {{-- property_management.contact_person --}}
                                        <label for="contact_person" class="title-color">{{ ui_change('contact_person','facility_master')  }}
                                        </label>
                            ...
                            <div class="col-sm-8 col-md-6 col-lg-4">
                                ...
                                <form action="{{ url()->current() }}" method="GET">
                                    <div class="input-group input-group-custom input-group-merge">
                                        ...
                                        <button type="submit" class="btn btn--primary">{{ ui_change('search','facility_master') }}</button>
                                    </div>
                                </form>
                                <!-- End Search -->
                            </div>
                    ...
                    <div style="text-align: {{ Session::get('locale') === 'ar' ? 'right' : 'left' }};">
                        <div class="table-responsive">
                            <table id="datatable"
                                ...
                                <tbody>
                                    @foreach ($amc_providers as $key => $item)
                                        <tr>
                                            <td>{{ $amc_providers->firstItem() + $key }}</td>
                                            <td class="text-center">{{ $item->code }}</td>
                                            <td class="text-center">{{ $item->name }}</td>
                                            <td class="text-center">{{ '(' . $item->dail_code_contact_no .')' . $item->contact_no }}</td>
                                            <td class="text-center">{{ '(' . $item->dail_code_whatsapp_no .')' . $item->whatsapp_no }}</td>
                                            <td class="text-center">{{ $item->city }}</td>
                                            <td class="text-center">{{ $item->state }}</td>
                                            <td class="text-center">{{ $item->country }}</td>
                                            <td class="text-center">
                                                <form action="{{ route('amc_provider.status-update') }}" method="post"
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center gap-2">
                                                    <a class="btn btn-outline-info btn-sm square-btn"
                                                        ...
                                                        href="{{ route('amc_provider.edit', $item->id) }}">
                                                        <i class="tio-edit"></i>
                                                    </a>

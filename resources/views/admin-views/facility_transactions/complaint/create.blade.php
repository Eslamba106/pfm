            ...
            <div class="col-md-12">
                <div class="card mb-3">
                    <div class="card-body" style="text-align: {{ Session::get('locale') === 'ar' ? 'right' : 'left' }};">
                        ...
                        <form action="{{ route('complaint_registration.storeComplaint') }}" method="post"
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-lg-4 col-xl-3">
                                        <div class="form-group">
                                            <label for=""
                                                class="form-control-label">{{ __('facility_transactions.complainer_name') }}
                                            </label>
                                            <input type="text" class="form-control" name="complainer_name">
                                    ...
                                    <div class="col-md-6 col-lg-4 col-xl-3">
                                        <div class="form-group">
                                            <label for="" class="form-control-label">{{ __('general.phone') }}
                                            </label>
                                    ...
                                    <div class="col-md-6 col-lg-4 col-xl-3">
                                        <div class="form-group">
                                            <label for=""
                                                class="form-control-label">{{ __('companies.email') }}</label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-lg-4 col-xl-6">
                                        <div class="form-group">
                                            <label for=""
                                                class="form-control-label">{{ __('property_master.units') }} <span
                                    ...
                                    <div class="col-md-6 col-lg-4 col-xl-3">
                                        <div class="form-group">
                                            <label for=""
                                                class="form-control-label">{{ __('facility_transactions.complaint_category') }}
                                                <span class="text-danger"> *</span> </label>
                                    ...
                                    <div class="col-md-6 col-lg-4 col-xl-3">
                                        <div class="form-group">
                                            <label for=""
                                                class="form-control-label">{{ __('property_master.main_complaint') }} <span
                                                    class="text-danger"> *</span></label>
                                            <select class="form-control" name="complaint" id="">
                                                <option selected>{{ __('general.select') }}</option>
                                                @foreach ($sub_complaints as $sub_complaint)
                                                    <option value="{{ $sub_complaint->id }}">{{ $sub_complaint->name }}
                                                    </option>
                                                @endforeach
                                    ...
                                    <div class="col-md-6 col-lg-4 col-xl-12">
                                        <div class="form-group">
                                            <label for=""
                                                class="form-control-label">{{ __('facility_transactions.complaint_comment') }}
                                            </label>
                                            <textarea class="form-control" name="complaint_comment" id="" cols="30" rows="2"></textarea>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-lg-4 col-xl-3">
                                        <div class="form-group">
                                            <label for="" class="form-control-label">{{ __('roles.departments') }}
                                                <span class="text-danger"> *</span></label>
                                    ...
                                    <div class="col-md-6 col-lg-4 col-xl-3 employee_select d-none"   >
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="employee_id">
                                                <option value="-1" selected>{{ __('general.select') }}</option>
                                            </select> 
                                            @error('employee_id')
                                                <span class="text-red">
                                    ...
                                    <div class="col-md-6 col-lg-4 col-xl-3">
                                        <div class="form-group">
                                            <label for="" class="form-control-label">{{ __('roles.priority') }}
                                                <span class="text-danger"> *</span></label>
                                    ...
                                    <div class="col-md-6 col-lg-4 col-xl-3">
                                        <div class="form-group">
                                            <label for=""
                                                class="form-control-label">{{ __('roles.attachments') }} <span
                                    ...
                                    <div class="col-md-6 col-lg-4 col-xl-3">
                                        <div class="form-group">
                                            ...
                                            <input type="time" class="form-control" name="attachment_time">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-lg-12 col-xl-12">
                                        <div class="form-group">
                                            <label for="" class="form-control-label">{{ ui_change('attachment_remark' , 'facility_transaction') }} </label>
                                            <textarea type="time" class="form-control"  cols="30" rows="2"  name="attachment_note"></textarea>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="d-flex gap-3 justify-content-end">
                                <button type="submit" class="btn btn--primary px-4"><i class="fa fa-plus-square"></i>
    ...
    <script>
        $(document).ready(function() {
            $('select[name="department"]').on('change', function() {
                ...
                if (department_id) {
                    $.ajax({
                        url: "{{ route('get_employees_departments', ':id') }}".replace(':id',
                            department_id),
                        type: "GET",
                        dataType: "json",
                    ...
                    employeeSelect.empty().append('<option value="">اختر موظفًا</option>').prop('disabled',
                        true);
                }
            });
        });
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            if (department_id) {
                                ...
                                $.ajax({
                                    url: "{{ route('get_employees_departments', ':id') }}"
                                        .replace(':id', department_id),
                                    type: "GET",
                                    dataType: "json",
                                    success: function(response) {
                                        employeeSelect.empty();

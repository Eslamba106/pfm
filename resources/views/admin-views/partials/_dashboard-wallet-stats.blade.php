            ...
            <div class="card card-body h-100 justify-content-center">
                <div class="d-flex gap-2 justify-content-between align-items-center">
                    <div class="d-flex flex-column align-items-start">
                        ...
                        <div class="text-capitalize mb-0">{{__('commission_earned')}}</div>
                    </div>
                    <div>
            ...
            <div class="card card-body h-100 justify-content-center">
                <div class="d-flex gap-2 justify-content-between align-items-center">
                    <div class="d-flex flex-column align-items-start">
                        ...
                        <div class="text-capitalize mb-0">{{__('delivery_charge_earned')}}</div>
                    </div>
                    <div>
            ...
            <div class="card card-body h-100 justify-content-center">
                <div class="d-flex gap-2 justify-content-between align-items-center">
                    <div class="d-flex flex-column align-items-start">
                        ...
                        <div class="text-capitalize mb-0">{{__('total_tax_collected')}}</div>
                    </div>
                    <div>
            ...
            <div class="card card-body h-100 justify-content-center">
                <div class="d-flex gap-2 justify-content-between align-items-center">
                    <div class="d-flex flex-column align-items-start">
                        ...
                        <div class="text-capitalize mb-0">{{__('pending_amount')}}</div>
                    </div>
                    <div>

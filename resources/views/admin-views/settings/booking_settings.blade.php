...
@section('content')
    <div class="content container-fluid">
        ...
        @include('admin-views.settings.business-setup-inline-menu')
            ...
            <!-- Form -->
            <form class="product-form text-start" action="{{ ($end == 'booking') ? route('booking_settings.store') : route('booking_settings.store') }}" method="POST" enctype="multipart/form-data" id="product_form">
                @csrf
                @method('patch')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="booking_prefix"   value="{{  $booking_prefix}}">
                                </div>
                            </div>

                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <div class="form-group">
                                    <label for="token" class="title-color">{{ __('property_transactions.booking_digits') }}</label>
                                    <input type="text" class="form-control" name="booking_digits" value="{{  $booking_digits }}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 col-lg-4 col-xl-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="booking_start_date" name="booking_date" value="{{  (isset($booking_date)) ? \Carbon\Carbon::parse($booking_date)->format('d-m-Y') : \Carbon\Carbon::now()->format('d-m-Y') }}" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-12 col-lg-4 col-xl-3">
                                <div class="form-group">

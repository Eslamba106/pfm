...
@section('title', __('roles.create_agreement'))
@php
    ...
    <div class="content container-fluid">
        ...
        <div class="mb-3">
            <h2 class="h1 mb-0 text-capitalize d-flex gap-2">
                ...
                {{ __('roles.create_agreement') }}
            </h2>
        </div>
        <!-- End Page Title -->

        <!-- Form -->
        <form class="product-form text-start" action="{{ route('agreement.store') }}" method="POST"
            ...
            <div class="card mt-3 rest-part">
                <div class="card-header">
                    <div class="d-flex gap-2">
                        <img width="40px" src="{{ asset('/public/assets/back-end/img/agreement.jpg') }}" class="mb-1"
                            alt="">

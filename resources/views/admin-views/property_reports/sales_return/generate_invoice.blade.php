...
@section('content')
    <div class="content container-fluid">
        ...
        <a class="btn btn--primary mt-3" target="_blank"
            href="{{ route('invoice.pdf', $invoice->id) }}">{{ ui_change('print', 'property_report') }}</a>
                ...
                <div class="card " id="printableArea">
                        ...
                        <div class="invoice-body-two">
                            <div class="invoice-section-two">
                                ...
                                @if (isset($tenant->contact_person))
                                    <p>{{ ui_change('contact_person', 'property_report') }} :
                            ...
                            <div class="invoice-section-two">
                                <p><span class="bold-two">{{ ui_change('invoice_number', 'property_report') }}:</span>
                                    <span class="bold-two">{{ $invoice->invoice_number }}</span></p>
                    ...
                    <div class="invoice">
                        <div class="amount-box">
                            <span>{{ ui_change('Sub_Total_Amount_in_words', 'property_report') }}
                                ({{ $company->currency_code }})
                                {{ amount_in_words($sub_total, $company->decimals) }}</span>
                        </div>
                        <div class="amount-box">
                            <span>{{ ui_change('VAT_Amount_in_words', 'property_report') }}
                                ({{ $company->currency_code }})

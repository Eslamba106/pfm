...
@endphp
@section('title', ui_change('sales_return_settings'))
    ...
    <div class="content container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center gap-3 mb-3">
            <h2 class="h1 mb-0 text-capitalize d-flex align-items-center gap-2">
                {{ ui_change('sales_return_settings') }}
            </h2>
                ...
                <div class="card">
                            ...
                            <table id="datatable"
                                ...
                                <thead class="thead-light thead-50 text-capitalize">
                                    <tr>
                                        ...
                                        <th class="text-center">{{ ui_change('sales_return_type') }}</th>
                                        <th class="text-center">{{ ui_change('ledger') }}</th>
                                        <th class="text-center">{{ ui_change('sales_return_with_logo') }}</th>
                                        <th class="text-center">{{ ui_change('sales_return_logo_position') }}</th>
                                        <th class="text-center">{{ ui_change('actions') }}</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @foreach ($sales_return_settings as $key => $value)
                                        <tr>
                                            <td>{{ $sales_return_settings->firstItem() + $key }}</td>
                    ...
                    <div class="table-responsive mt-4">
                        <div class="d-flex justify-content-lg-end">
                            <!-- Pagination -->
                            {!! $sales_return_settings->links() !!}
                        </div>
                    </div>

                    @if (count($sales_return_settings) == 0)
    ...
    <div class="modal fade " id="add_new_ledger" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('sales_return_settings.store') }}" method="post">
                    @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-4 col-xl-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="sales_return_suffix"
                                        class="form-control">
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-4 col-xl-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="sales_return_width">
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 col-lg-4 col-xl-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="sales_return_start_number"
                                        class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 col-lg-4 col-xl-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="sales_return_start_date"
                                        name="sales_return_date" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-12 col-lg-4 col-xl-6">
                                <div class="form-group">
                                    <label for="">{{ ui_change('sales_return_name') }}</label>
                                    <input type="text" class="form-control" name="sales_return_name" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-12 col-lg-4 col-xl-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-6">
                                <div class="form-group">
                                    <label for="token"
                                        class="title-color">{{ ui_change('sales_return_type') }}</label>
                                    <input type="text" class="form-control" name="sales_return_type">
                                </div>
                            </div>
                            <div class="col-md-12 col-lg-4 col-xl-6">
                                <div class="form-group">
                                    <label for="">{{ ui_change('sales_return_with_logo') }}</label>
                                    <select name="sales_return_with_logo" class="js-select2-custom form-control">
                                        <option value="yes">
                                            {{ ui_change('yes') }}
                                        </option>
                                        <option value="no">
                            ...
                            <div class="col-md-12 col-lg-4 col-xl-6">
                                <div class="form-group">
                                    <label for="">{{ ui_change('sales_return_logo_position') }}</label>
                                    <select name="sales_return_logo_position" class="js-select2-custom form-control">
                                        <option value="right">
                                            {{ ui_change('right') }}
                                        </option>
                                        <option value="left">
                            ...
                            <div class="col-md-12 col-lg-4 col-xl-6">
                                <div class="form-group">
                                    ...
                                    <select name="sales_return_format" class="js-select2-custom form-control">
    ...
    <div class="modal fade" id="edit_receipt_settings" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('sales_return_settings.update') }}" method="post">
                    @csrf
                    @method('patch')
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-6">
                                <div class="form-group">
                                    <label for="token" class="title-color">{{ ui_change('prefix') }}</label>
                                    <input type="text" class="form-control" name="sales_return_prefix" id="edit_prefix">
                                    <input type="hidden" class="form-control" name="edit_sales_return_settings_id"
                                        id="edit_sales_return_settings_id">
                                </div>
                            </div>
                            <div class="col-md-12 col-lg-4 col-xl-6">
                                <div class="form-group">
                                    <label for="">{{ ui_change('sufix') }}</label>
                                    <input type="text" class="form-control" name="sales_return_suffix" id="edit_suffix"
                                        class="form-control">
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-4 col-xl-6">
                                <div class="form-group">
                                    <label for="token" class="title-color">{{ ui_change('total_digit') }}</label>
                                    <input type="number" class="form-control" name="sales_return_width" id="edit_width">
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-4 col-xl-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-12 col-lg-4 col-xl-6">
                                <div class="form-group">
                                    <label for="">{{ ui_change('start_date') }}</label>
                                    <input type="text" class="form-control" id="edit_sales_return_start_date"
                                        name="sales_return_date" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-12 col-lg-4 col-xl-3">
                                <div class="form-group">
                                    <label for="">{{ ui_change('sales_return_name') }}</label>
                                    <input type="text" class="form-control" name="sales_return_name"
                                        id="edit_sales_return_name" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-12 col-lg-4 col-xl-3">
                                <div class="form-group">
                                    <label for="">{{ ui_change('sales_return_with_logo') }}</label>
                                    <select name="sales_return_with_logo" id="edit_sales_return_with_logo"
                            ...
                            <div class="col-md-12 col-lg-4 col-xl-3">
                                <div class="form-group">
                                    <label for="">{{ ui_change('sales_return_logo_position') }}</label>
                                    <select name="sales_return_logo_position" id="edit_sales_return_logo_position"
                                        class="js-select2-custom form-control">
                                        <option value="right">
                                            {{ ui_change('right') }}
                                        </option>
...
@push('script')
        ...
        $(document).on('click', '.delete', function() {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        url: "{{ route('sales_return_settings.delete') }}",
                        method: 'get',
                        data: {
                            id: id
                        },
    ...
    <script>
        flatpickr("#edit_sales_return_start_date", {
            dateFormat: "d/m/Y",
            defaultDate: "today",
        });

        flatpickr("#sales_return_start_date", {
            dateFormat: "d/m/Y",
            defaultDate: "today",
        });
    </script>
    <script>
        $(document).on('click', '#edit_receipt_settings_item', function(e) {
            ...
            $.ajax({
                type: "GET",
                url: "{{ route('sales_return_settings.edit', ':id') }}".replace(':id', sect_id),
                success: function(response) {
                    if (response.status == 404) {
                        ...
                        let main_date = response.sales_return_settings.applicable_date;
                        if (main_date) {
                            let formattedDate = moment(main_date, "YYYY-MM-DD").format("DD/MM/YYYY");
                            $('#edit_sales_return_start_date').val(formattedDate)
                        }
                        $('#edit_sales_return_settings_id').val(sect_id)
                        $('#edit_sales_return_name').val(response.sales_return_settings.invoice_name)
                        $('#edit_prefix').val(response.sales_return_settings.invoice_prefix)
                        $('#edit_suffix').val(response.sales_return_settings.invoice_suffix)
                        $('#edit_start_number').val(response.sales_return_settings.invoice_start_number)
                        $('#edit_width').val(response.sales_return_settings.invoice_width)
                        $('#edit_sales_return_type').val(response.sales_return_settings.invoice_type)
                        $('#edit_height').val(response.sales_return_settings.height)
                        $('#edit_logo_width').val(response.sales_return_settings.width)
                        $('#qr_code_height').val(response.sales_return_settings.qr_code_height)
                        $('#qr_code_width').val(response.sales_return_settings.qr_code_width)
                        // $('#edit_sales_return_with_logo').val(response.sales_return_settings.sales_return_with_logo)
                        // $('#edit_sales_return_logo_position').val(response.sales_return_settings.sales_return_logo_position)
                        let ledgerId = response.sales_return_settings.ledger_id ?? 0;
                        $('#edit_ledger_id').val(ledgerId).trigger('change');

                        $('#edit_sales_return_logo_position').val(response.sales_return_settings
                            .invoice_logo_position).trigger('change');
                        $('#edit_sales_return_with_logo').val(response.sales_return_settings.invoice_with_logo)
                            .trigger('change');

                        $('#edit_format').val(response.sales_return_settings.invoice_format)
                            .trigger('change');
                        $('#format_color').val(response.sales_return_settings.format_color);
                        $('#background_color').val(response.sales_return_settings.background_color);
 
                        let settings = response.sales_return_settings;

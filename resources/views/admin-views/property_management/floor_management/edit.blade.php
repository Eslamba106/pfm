                          ...
                          <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <select class="js-select2-custom form-control" name="type" required  >
                                    ...
                                    <option {{ ($old_floor->long_status == "long_term") ? 'selected' : '' }} value="long_term">{{ ui_change('long_term', 'property_config') }}</option>
                                    <option {{ ($old_floor->long_status == "short_term") ? 'selected' : '' }} value="short_term">{{ ui_change('short_term', 'property_config') }}</option>
                                    <option {{ ($old_floor->long_status == "daily") ? 'selected' : '' }} value="daily">{{ ui_change('daily', 'property_config') }}</option>
                                    <option {{ ($old_floor->long_status == "others") ? 'selected' : '' }} value="others">{{ ui_change('others', 'property_config') }}</option> 
                                </select>
                            </div>
                        </div>

...
@section('content')
    <div class="content container-fluid">
        ...
        <!-- Form -->
        <form class="product-form text-start" action="{{ route('property_management.update' , $property_management->id) }}" method="POST"
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-4 col-xl-4">
                            <div class="form-group">
                                <label for="name"
                                    class="title-color">{{ ui_change('property_name' , 'property_config') }}<span class="text-danger"> *</span>
                                </label>
                                <input type="text" class="form-control" name="name" value="{{ $property_management->name }}">
                                @error('name')
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-4">
                            <div class="form-group">
                                <label for="code"
                                    class="title-color">{{ ui_change('property_code' , 'property_config') }}<span class="text-danger"> *</span>
                                </label>
                                <input type="text" class="form-control" name="code" value="{{ $property_management->code }}">
                            </div>
                            @error('code')
                                <div class="invalid-feedback">
                                    {{ $message }}
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-4">
                            <div class="form-group">
                                <label for="name" class="title-color">{{ ui_change('ownership' , 'property_config') }}<span class="text-danger"> *</span>
                                ...
                                <select class="js-select2-custom form-control" name="ownership_id" required>
                                    ...
                                    @foreach ($owner_ship as $ownership)
                                        <option value="{{ $ownership->id }}" {{ ($property_management->ownership_id == $ownership->id ) ? 'selected' : '' }}>{{ $ownership->name }}
                                        </option>
                                    @endforeach
                                </select>
                                @error('ownership_id')
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-4">
                            <div class="form-group">
                                <label for="name" class="title-color">{{ ui_change('property_type' , 'property_config') }}<span class="text-danger"> *</span>

                                </label>
                                <select class="js-select2-custom form-control" name="property_type_id[]" multiple required multiple="multiple">
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="building_no" value="{{ $property_management->building_no }}">
                                @error('building_no')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="block_no" value="{{ $property_management->block_no }}">
                                @error('block_no')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="road" value="{{ $property_management->road }}">
                                @error('road')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="location" value="{{ $property_management->location }}">
                                @error('location')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="city" value="{{ $property_management->city }}">
                                @error('city')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-4">
                            <div class="form-group">
                                <label for="name" class="title-color">{{ ui_change('country' , 'property_config') }}<span class="text-danger"> *</span>

                                </label>
                                <select class="js-select2-custom form-control" name="country_master_id" required>
                                    <option value="">{{ ui_change('select' , 'property_config') }}</option>
                                    @foreach ($country_master as $country)
                                        <option value="{{ $country->id }}" {{ ($property_management->country_master_id == $country->id) ? 'selected' : '' }}>{{ $country->country->name }}
                                        </option>
                                    @endforeach
                                </select>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-4 col-xl-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="bank_name" value="{{ $property_management->bank_name }}">
                                @error('bank_name')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="bank_no" value="{{ $property_management->bank_no }}">
                                @error('bank_no')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="contact_person" value="{{ $property_management->contact_person }}">
                            </div>
                                ...
                                {{-- <input type="text" class="form-control" name="dail_code_telephone" value="{{ $property_management->dail_code_telephone }}"
                                    ...
                                    <select class="js-select2-custom form-control" name="dail_code_telephone" >
                                        ...
                                        @foreach ($dail_code_main as $item_dail_code)
                                            <option value="{{ '+' . $item_dail_code->dial_code }}"   {{ ($item_dail_code->dial_code == $property_management->dail_code_telephone) ? 'selected' : '' }} >
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="telephone" value="{{ $property_management->telephone }}">
                            </div>
                            @error('telephone')
                                <div class="invalid-feedback">
                                    {{ $message }}
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-2">
                            <div class="form-group">
                                ...
                                <select class="js-select2-custom form-control" name="dail_code_mobile"   >
                                    <option >{{ ui_change('select' , 'property_config') }}</option>
                                    @foreach ($dail_code_main as $item_dail_code)
                                        <option value="{{ '+' . $item_dail_code->dial_code }}"  {{ ($item_dail_code->dial_code == $property_management->dail_code_mobile) ? 'selected' : '' }}>
                                            {{ '+' . $item_dail_code->dial_code }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="mobile" value="{{ $property_management->mobile }}">
                            </div>
                            @error('mobile')
                                <div class="invalid-feedback">
                                    {{ $message }}
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="email" value="{{ $property_management->email }}">
                            </div>
                            @error('email')
                                <div class="invalid-feedback">
                                    {{ $message }}
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-2">
                            <div class="form-group">
                                ...
                                <select class="js-select2-custom form-control" name="dail_code_fax"  >
                                    <option >{{ ui_change('select' , 'property_config') }}</option>
                                    @foreach ($dail_code_main as $item_dail_code)
                                        <option value="{{ '+' . $item_dail_code->dial_code }}"   {{ ( $item_dail_code->dial_code == $property_management->dail_code_fax) ? 'selected' : '' }}>
                                            {{ '+' . $item_dail_code->dial_code }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="fax" value="{{ $property_management->fax }}">
                            </div>
                            @error('fax')
                                <div class="invalid-feedback">
                                    {{ $message }}
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="total_area" value="{{ $property_management->total_area }}">
                            </div>
                            @error('total_area')
                                <div class="invalid-feedback">
                                    {{ $message }}
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="insurance_period_from" id="insurance_period_from_edit">
                            </div>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="insurance_period_to" id="insurance_period_to_edit">
                            </div>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="insurance_type" value="{{ $property_management->insurance_type }}">
                            </div>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="insurance_policy_no" value="{{ $property_management->insurance_policy_no }}">
                            </div>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="insurance_holder" value="{{ $property_management->insurance_holder }}">
                            </div>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="premium_amount" value="{{ $property_management->premium_amount }}">
                            </div>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3 ">
                            ...
                            <div class="input-group">
                                <input type="radio" name="status" class="mr-3 ml-3" {{ $property_management->status == 'active' ? 'checked' : '' }} value="active">
                                <label class="title-color" for="status">
                                    {{ ui_change('active' , 'property_config') }}
                                </label>
                                <input type="radio" name="status" class="mr-3 ml-3"  {{ $property_management->status == 'inactive' ? 'checked' : '' }} value="inactive">
                                <label class="title-color" for="status">

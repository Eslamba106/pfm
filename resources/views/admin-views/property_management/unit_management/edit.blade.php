...
@section('content')
    <div class="content container-fluid">
        ...
        <!-- Form -->
        <form class="product-form text-start" action="{{ route('unit_management.update', $selected_unit->id) }}"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <select class="js-select2-custom form-control" name="property" id="property" disabled
                                    required>
                                    <option>{{ ui_change('select', 'property_config') }}
                                    </option>
                                    @foreach ($property as $property_item)
                                        <option value="{{ $property_item->id }}"
                                            @if ($selected_unit->property_management_id == $property_item->id) selected @endif>
                                            {{ $property_item->name }}
                                        </option>
                                    @endforeach
                                </select>
                                ...
                                <select class="js-select2-custom form-control" name="block" required disabled>
                                    ...
                                    @foreach ($blocks as $block_item)
                                        <option value="{{ $block_item->id }}"
                                            @if ($selected_unit->block_management_id == $block_item->id) selected @endif>
                                ...
                                <select class="js-select2-custom form-control" name="floor" id="floor" required
                                    ...
                                    @foreach ($floors as $floor_item)
                                        <option value="{{ $floor_item->id }}"
                                            @if ($selected_unit->floor_management_id == $floor_item->id) selected @endif>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <select class="js-select2-custom form-control" disabled name="start_up_unit"
                                    id="start_up_unit" required disabled>
                                    <option selected>{{ ui_change('select', 'property_config') }}
                                    </option>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                <label for="name" class="title-color">{{ ui_change('rental_type', 'property_config') }}
                                </label>
                                <select class="js-select2-custom form-control" name="type" required>
                                    <option selected>{{ ui_change('select', 'property_config') }} </option>
                                    <option {{ $selected_unit->long_status == 'long_term' ? 'selected' : '' }}
                                        value="long_term">{{ ui_change('long_term', 'property_config') }}</option>
                                    <option {{ $selected_unit->long_status == 'short_term' ? 'selected' : '' }}
                                        value="short_term">{{ ui_change('short_term', 'property_config') }}</option>
                                    <option {{ $selected_unit->long_status == 'daily' ? 'selected' : '' }} value="daily">
                                        {{ ui_change('daily', 'property_config') }}</option>
                                    <option {{ $selected_unit->long_status == 'others' ? 'selected' : '' }} value="others">
                                        {{ ui_change('others', 'property_config') }}</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4 col-xl-3">
                                ...
                                <select name="unit_description" class="js-select2-custom form-control"
                                    ...
                                    @foreach ($unit_descriptions as $unit_description_item)
                                        <option value="{{ $unit_description_item->id }}"
                                            @if ($selected_unit->unit_description_id == $unit_description_item->id) selected @endif>
                            ...
                            <div class="form-group">
                                ...
                                <select name="unit_type" class="js-select2-custom form-control" id="general_unit_type">
                                    ...
                                    @foreach ($unit_types as $unit_type_item)
                                        <option value="{{ $unit_type_item->id }}"
                                            @if ($selected_unit->unit_type_id == $unit_type_item->id) selected @endif>{{ $unit_type_item->name }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                                ...
                                <select name="unit_condition" class="js-select2-custom form-control"
                                    ...
                                    @foreach ($unit_conditions as $unit_condition_item)
                                        <option value="{{ $unit_condition_item->id }}"
                                            @if ($selected_unit->unit_condition_id == $unit_condition_item->id) selected @endif>
                                ...
                                <select name="view" class="js-select2-custom form-control" id="general_view">
                                    ...
                                    @foreach ($views as $view_item)
                                        <option value="{{ $view_item->id }}"
                                            @if ($selected_unit->view_id == $view_item->id) selected @endif> {{ $view_item->name }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                                ...
                                <select name="unit_parking" class="js-select2-custom form-control"
                                    ...
                                    @foreach ($unit_parkings as $unit_parking_item)
                                        <option value="{{ $unit_parking_item->id }}"
                                            @if ($selected_unit->unit_parking_id == $unit_parking_item->id) selected @endif>
                        ...
                        <div class="col-md-3  col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <input value="{{ $selected_unit->adults }}" type="number" id="general_adults"
                        ...
                        <div class="col-md-3  col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <input value="{{ $selected_unit->children }}" type="number" id="general_children"
                                    class="form-control" value="0" min="0">
                            </div>
                        </div>
                        <div class="col-md-12 col-lg-12 col-xl-12">
                            <label>{{ ui_change('facilities', 'property_config') }}</label>
                            <select id="general_unit_facilities" name="unit_facilities[]"
                                class="js-select2-custom form-control" multiple>
                                @foreach ($facilities as $item)
                                    <option value="{{ $item->id }}"
                                        {{ $selected_unit->facilities && $selected_unit->facilities->contains($item->id) ? 'selected' : '' }}>
                                        {{ $item->name }}</option>
                                @endforeach
                            </select>
                        </div>

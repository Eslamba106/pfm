                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                <label for="name"
                                    class="title-color">{{ ui_change('start_up_unit', 'property_config') }}
                                </label>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                <label for="token"
                                    class="title-color">{{ ui_change('Total_No._Unit_', 'property_config') }} <span
                    ...
                    <div class="unit-type-container d-flex justify-content-between">
                        ...
                        <div class="form-group  col-md-6 col-lg-4 col-xl-6 general_unit_type">
                            ...
                            <select name="unit_type[]" class="js-select2-custom form-control" id="general_unit_type">
                                <option value="0" selected>{{ ui_change('no_applicable', 'property_config') }}
                                </option>

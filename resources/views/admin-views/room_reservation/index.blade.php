            ...
            <div class="col-md-12 mb-3">
                <div class="card">
                    <div class="card-header">
                        {{ ui_change('add_new_' . $route, 'room_reservation') }}
                    </div>
                        ...
                        <form action="{{ route($route . '.store') }}" method="post">
                            ...
                            @if ($route == 'room_block' || $route == 'room_floor')
                                <div class="form-group ">
                                    <label for="">{{ ui_change('Building') }}<span class="text-danger">
                                            *</span></label>
                                    <select class="js-select2-custom form-control" onchange="get_blocks()" id="building_id"
                            ...
                            @if ($route == 'room_floor')
                                <div class="form-group ">
                                    <label for="">{{ ui_change('Block') }}<span class="text-danger">
                                            *</span></label>
                                    <select class="js-select2-custom form-control" id="block_id" name="block_id" required>
                                        <option selected value="">{{ ui_change('select', 'property_master') }}
                                        </option>
                            ...
                            <div class="form-group">
                                ...
                                <label class="title-color" for="name">{{ ui_change('name', 'room_reservation') }}<span
                                        class="text-danger"> *</span> </label>
                                <input type="text" name="name" class="form-control"
                                    placeholder="{{ ui_change('enter_' . $route . '_name', 'room_reservation') }}">
                            </div>
                            <div class="form-group">
                                <label class="title-color" for="code">
                                    {{ ui_change('code', 'room_reservation') }}<span class="text-danger"> *</span>

                                </label>
                                <div class="input-group">
                                    <input type="text" name="code" class="form-control"
                                        placeholder="{{ ui_change('enter_' . $route . '_code', 'room_reservation') }}">

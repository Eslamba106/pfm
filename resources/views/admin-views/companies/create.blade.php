...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="container-fluid">
            ...
            <!-- Start Page Content -->
            <!-- ============================================================== -->
            <form id="signature-form" action="{{ route('companies.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                <!-- general setup -->
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-4 col-xl-2">
                                <div class="form-group">
                                    <label for="phone_dail_code" class="title-color">{{ __('companies.dail_code') }}</label>

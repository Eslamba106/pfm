                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                <label for="name" required class="title-color">{{ ui_change('name', 'hierarchy') }}
                                </label>
                                <input type="text" id="name" value="{{ $company->name }}" class="form-control" name="name">
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                <label for="lang_name"
                                    class="title-color">{{ ui_change('Translated_Name', 'hierarchy') }}<span
                                        class="text-danger">*</span>
                                </label>
                                <input type="text" value="{{ $company->lang_name }}" class="form-control"
                                    name="lang_name" id="lang_name">
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                <label for="name"
                                    class="title-color">{{ ui_change('opening_time', 'hierarchy') }}</label>
                                <input type="time" value="{{ $company->opening_time }}" class="form-control"
                                    name="opening_time">
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                <label for="name"
                                    class="title-color">{{ ui_change('closing_time', 'hierarchy') }}</label>
                                <input type="time" value="{{ $company->closing_time }}" class="form-control"
                                    name="closing_time">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 col-lg-4 col-xl-2">
                            <div class="form-group">
                                <label for="name" class="title-color">{{ ui_change('dail_code', 'hierarchy') }}</label>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-2">
                            <div class="form-group">
                                <label for="name" class="title-color">{{ ui_change('phone', 'hierarchy') }}</label>
                                <input type="number" value="{{ $company->phone }}" class="form-control" name="phone">
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4 col-xl-2">
                            <div class="form-group">
                                <label for="name" class="title-color">{{ ui_change('dail_code', 'hierarchy') }}
                                </label>
                                {{-- <input type="text" value="{{ $company->fax_dail_code }}" class="form-control"
                                    name="fax_dail_code" placeholder="+935"> --}}
                                <select class="js-select2-custom form-control" name="fax_dail_code">
                                    <option value="" selected>{{ ui_change('select', 'hierarchy') }}</option>
                                    @foreach ($dail_code_main as $item_dail_code)
                                        <option value="{{ '+' . $item_dail_code->dial_code }}"
                                            {{ '+' . $item_dail_code->dial_code == $company->fax_dail_code ? 'selected' : '' }}>
                                            {{ '+' . $item_dail_code->dial_code }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-2">
                            <div class="form-group">
                                ...
                                <input type="number" value="{{ $company->fax }}" class="form-control" name="fax">
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                <label for="name"
                                    class="title-color">{{ ui_change('financial_year_start_ith', 'hierarchy') }}</label>
                                <input type="text" name="financial_year" id="financial_year_start_edit"
                                    class="form-control" value="{{ $company->financial_year }}">
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                <label for="name"
                                    class="title-color">{{ ui_change('book_begining_with', 'hierarchy') }}</label>
                                <input type="text" class="form-control" name="book_begining"
                                    id="booking_beging_with_edit">
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                <label for="user_name" class="title-color">{{ ui_change('user_name', 'hierarchy') }}<span
                                        class="text-danger">*</span>
                                </label>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <label for="user_name" class="title-color">{{ ui_change('password', 'hierarchy') }}</label>
                            ...
                            <div class="form-group input-group input-group-merge">
                                ...
                                <input type="password" class="js-toggle-password form-control" name="password"
                                    id="signupSrPassword" value="{{ $user->my_name }}"
                ...
                <div class="card-body">
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6 mb-4 mb-lg-0">
                            ...
                            <div class="form-group">
                                <label for="exampleFirstName" class="title-color d-flex gap-1 align-items-center">
                                    @if ($isSaudi)
                                ...
                                <input type="text" id="address1" class="form-control form-control-user" id="exampleFirstName"
                                    name="address1" value="{{ $company->address1 }}">
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-user"  
                                    name="lang_address1" id="lang_address1"  value="{{ $company->lang_address1 }}">
                            </div>
                            @if (!$isSaudi)
                                <div class="form-group">
                                    <label for="exampleLastName"
                                        class="title-color d-flex gap-1 align-items-center">{{ ui_change('address2', 'hierarchy') }}</label>
                                    <input type="text" class="form-control form-control-user" 
                                        name="address2" id="address2"  value="{{ $company->address2 }}">
                                </div>
                                <div class="form-group">
                                    <label for="lang_address2"
                                        class="title-color d-flex gap-1 align-items-center">{{ ui_change('Translated_Address_2', 'hierarchy') }}</label>
                                    <input type="text" class="form-control form-control-user"  
                                        name="lang_address2" id="lang_address2"  value="{{ $company->lang_address2 }}">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPhone"
                                        class="title-color d-flex gap-1 align-items-center">{{ ui_change('address3', 'hierarchy') }}</label>
                                    <input type="text" class="form-control form-control-user"  
                                        name="address3" id="address3"  value="{{ $company->address3 }}">
                                </div>
                                <div class="form-group">
                                    <label for="lang_address3"
                                        class="title-color d-flex gap-1 align-items-center">{{ ui_change('Translated_Address_3', 'hierarchy') }}</label>
                                    <input type="text" id="lang_address3"  class="form-control form-control-user" 
                                        name="lang_address3" value="{{ $company->lang_address3 }}">
                                </div>
                            @endif
                        </div>
                        <div class="col-lg-6">
            ...
            <div class="card mt-3">
                <div class="card-body">
                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <select class="js-select2-custom form-control" name="countryid" required>
                                    ...
                                    @foreach ($country as $c)
                                        <option value="{{ $c->id }}"
                                            {{ $company->countryid == $c->id ? 'selected' : '' }}>
                                            {{ $c->country->name }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                <label for="name" class="title-color">{{ ui_change('region', 'hierarchy') }}
                                </label>
                                <input type="text" class="form-control form-control-user" readonly
                                    value="{{ $company->region }}" name="region" required>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                <label for="name" class="title-color">{{ ui_change('currency_name', 'hierarchy') }}
                                </label>
                                <input type="text" class="form-control form-control-user" readonly
                                    value="{{ $company->currency }}" name="currency" required>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                <label for="name" class="title-color">{{ ui_change('symbol', 'hierarchy') }}
                                </label>
                                <input type="text" class="form-control form-control-user" readonly
                                    value="{{ $company->symbol }}" name="symbol" required>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-user" readonly
                                    value="{{ $company->currency_code }}" name="currency_code" required>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-user" readonly
                                    value="{{ $company->denomination }}" name="denomination" required>

                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                <label for="name" class="title-color">{{ ui_change('no_of_decimals', 'hierarchy') }}
                                </label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                <label for="name" class="title-color">{{ ui_change('email', 'hierarchy') }}</label>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                <label for="name" class="title-color">{{ ui_change('state', 'hierarchy') }}</label>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                <label for="user_name" class="title-color">{{ ui_change('city', 'hierarchy') }}</label>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                <label for="user_name"
                                    class="title-color">{{ ui_change('location', 'hierarchy') }}</label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                <label for="name" class="title-color">{{ ui_change('pin', 'hierarchy') }}</label>
                                <input type="text" name="pin" class="form-control" value="{{ $company->pin }}">
                            </div>
                        </div>
                        {{-- {{ dd($company->logo_image) }} --}}
                        <div class="col-md-6 col-lg-4 col-xl-2">
                            <div class="form-group">
                                <label for="name"
                                    class="title-color">{{ ui_change('dail_code', 'hierarchy') }}</label>

                                {{-- <input type="text" value="{{ $company->mobile_dail_code }}" class="form-control"
                                    name="mobile_dail_code" placeholder="+935"> --}}
                                <select class="js-select2-custom form-control" name="mobile_dail_code">
                                    <option value="" selected>{{ ui_change('select', 'hierarchy') }}</option>
                                    @foreach ($dail_code_main as $item_dail_code)
                                        <option value="{{ '+' . $item_dail_code->dial_code }}"
                                            {{ '+' . $item_dail_code->dial_code == $company->mobile_dail_code ? 'selected' : '' }}>
                                            {{ '+' . $item_dail_code->dial_code }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-2">
                            <div class="form-group">
                                <label for="user_name" class="title-color">{{ ui_change('mobile', 'hierarchy') }}</label>
                                <input type="number" name="mobile" value="{{ $company->mobile }}"
                                    class="form-control">
                            </div>
                        </div>
            ...
            <div class="card mt-3">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3 ">
                            <div class="form-group">
                                <label for="name" class="title-color">{{ ui_change('taxability', 'hierarchy') }}
                                </label>
                                <select class="js-select2-custom form-control" name="tax_type" required>
                                    <option value="" selected>{{ ui_change('select', 'hierarchy') }}</option>

                                    <option value="1" {{ 1 == $company->tax_type ? 'selected' : '' }}>
                                        {{ ui_change('taxable', 'hierarchy') }}</option>
                                    <option value="2" {{ 2 == $company->tax_type ? 'selected' : '' }}>
                                        {{ ui_change('zero_rated', 'hierarchy') }}</option>
                                    <option value="3" {{ 3 == $company->tax_type ? 'selected' : '' }}>
                                        {{ ui_change('exempted', 'hierarchy') }}</option>
                                    <option value="4" {{ 4 == $company->tax_type ? 'selected' : '' }}>
                        ...
                        <div
                            class="col-md-6 col-lg-4 col-xl-3  {{ $company->tax_type == 1 ? '' : 'd-none' }} tax_status_html tax_status_saudi_html">
                            <div class="form-group">
                                <label for="name" class="title-color">{{ ui_change('vat_no', 'hierarchy') }}
                                </label>
                        ...
                        <div
                            class="col-md-6 col-lg-4 col-xl-3  {{ $company->tax_type == 1 ? '' : 'd-none' }} tax_status_html tax_status_saudi_html">
                            <div class="form-group">
                                <label for="name" class="title-color">{{ ui_change('group_vat_no', 'hierarchy') }}
                                </label>
                                <input type="text" name="group_vat_no" class="form-control"
                                    value="{{ $company->group_vat_no }}">
                            </div>
                        </div>
                        <div
                            class="col-md-6 col-lg-4 col-xl-3  {{ $company->tax_type == 1 ? '' : 'd-none' }} tax_status_html tax_status_saudi_html">
                            <div class="form-group">
                                <label for="name"
                                    class="title-color">{{ ui_change('tax_registration_date', 'hierarchy') }}
                                </label>
                                <input type="date" name="tax_reg_date" id="tax_registration_date_edit"
                                    class="form-control" value="{{ $company->tax_reg_date }}">
                            </div>
                        </div>

                        <div
                            class="col-md-6 col-lg-4 col-xl-3  {{ $company->tax_type == 1 && $isSaudi != 2 ? '' : 'd-none' }} tax_status_html">
                            <div class="form-group">
                                <label for="name" class="title-color">{{ ui_change('tax_rate', 'hierarchy') }}
                                </label>
                        ...
                        <div
                            class="col-md-6 col-lg-4 col-xl-3  {{ $company->tax_type == 1 && $isSaudi != 2 ? '' : 'd-none' }} mt-5 tax_status_html">
                            <div class="form-group">
                                <input type="radio" name="status" value="active" checked>
                                <label for="name" class="title-color">{{ ui_change('active', 'hierarchy') }}
                                </label>
                                <input type="radio" name="status" value="inactive"
                                    class="{{ $lang == 'ar' ? 'mr-3' : 'ml-3' }}">
                                <label for="name" class="title-color">{{ ui_change('inactive', 'hierarchy') }}
                                </label>
                            </div>
                        </div>
                        ...
                        <!-- Saudi Tax Info -->
                        <div
                            class="col-md-6 col-lg-4 col-xl-3  {{ $company->tax_type == 1 && $isSaudi == 2 ? '' : 'd-none' }} tax_status_saudi_html">
                            <div class="form-group">
                                <label for="organization_unit_name"
                                    class="title-color">{{ ui_change('organization_unit_name', 'hierarchy') }}
                                </label>
                                <input type="text" name="organization_unit_name" id="organization_unit_name_edit"
                                    class="form-control" value="{{ $company->organization_unit_name }}">
                            </div>
                        </div>
                        <div
                            class="col-md-6 col-lg-4 col-xl-3  {{ $company->tax_type == 1 && $isSaudi == 2 ? '' : 'd-none' }} tax_status_saudi_html">
                            <div class="form-group">
                                <label for="commercial_registration_number"
                                    class="title-color">{{ ui_change('commercial_registration_number', 'hierarchy') }}
                                </label>
                        ...
                        <div
                            ...
                            <div class="form-group">
                                <label for="invoice_type"
                                    class="title-color">{{ ui_change('invoice_type', 'hierarchy') }}
                                </label>
                                <select class="js-select2-custom form-control" name="invoice_type">
                                    <option value="" selected>{{ ui_change('select', 'hierarchy') }}</option>

                                    <option value="1100" {{ 1100 == $company->invoice_type ? 'selected' : '' }}>
                                        {{ ui_change('both', 'hierarchy') }}</option>
                                    <option value="0100" {{ 0100 == $company->invoice_type ? 'selected' : '' }}>
                                        {{ ui_change('simplified_invoice', 'hierarchy') }}</option>
                                    <option value="1000" {{ 1000 == $company->invoice_type ? 'selected' : '' }}>
                        ...
                        <div
                            class="col-md-6 col-lg-4 col-xl-3 {{ $company->tax_type == 1 && $isSaudi == 2 ? '' : 'd-none' }} tax_status_saudi_html">
                            <div class="form-group">
                                <label for="environment" class="title-color">{{ ui_change('environment', 'hierarchy') }}
                                </label>
                                <select class="js-select2-custom form-control" name="environment">
                                    <option value="" selected>{{ ui_change('select', 'hierarchy') }}</option>

                                    <option value="developer-portal"
                                        {{ 'developer-portal' == $company->environment ? 'selected' : '' }}>
                                        {{ ui_change('test', 'hierarchy') }}</option>
                                    <option value="simulation"
                                        {{ 'simulation' == $company->environment ? 'selected' : '' }}>
                                        {{ ui_change('simulation', 'hierarchy') }}</option>
                                    <option value="core" {{ 'core' == $company->environment ? 'selected' : '' }}>
                        ...
                        <div
                            ...
                            <div class="form-group">
                                <label for="short_address"
                                    class="title-color">{{ ui_change('short_address', 'hierarchy') }}
                                </label>
                                <input type="text" name="short_address" id="short_address_edit" class="form-control"
                                    value="{{ $company->short_address }}">
                            </div>
                        </div>
                        <div
                            class="col-md-6 col-lg-4 col-xl-3  {{ $company->tax_type == 1 && $isSaudi == 2 ? '' : 'd-none' }} tax_status_saudi_html">
                            <div class="form-group">
                                <label for="Zip_Code" class="title-color">{{ ui_change('Zip_Code', 'hierarchy') }}
                                </label>
                        ...
                        <div
                            class="col-md-6 col-lg-4 col-xl-3  {{ $company->tax_type == 1 && $isSaudi == 2 ? '' : 'd-none' }} tax_status_saudi_html">
                            <div class="form-group">
                                <label for="OTP" class="title-color">{{ ui_change('OTP', 'hierarchy') }}
                                </label>
                        ...
                        <div
                            ...
                            <div class="form-group">
                                <label for="company_category"
                                    class="title-color">{{ ui_change('company_category', 'hierarchy') }}
                                </label>
                                <input type="text" name="company_category" id="company_category_edit"
                                    class="form-control" value="{{ $company->company_category }}">
                            </div>
                        </div>
                        <!-- Saudi Tax Info -->

                            ...
                            <table id="datatable"
                                ...
                                <thead class="thead-light thead-50 text-capitalize">
                                    <tr>
                                        <th><input id="bulk_check_all" class="bulk_check_all" type="checkbox" />
                                            {{ __('general.sl') }}</th>
                                        <th class="text-center">{{ __('property_reports.property') }}</th>
                                        <th class="text-center">{{ __('property_master.unit') }}</th>
                                        <th class="text-center">{{ __('property_master.unit_type') }}</th>
                                        <th class="text-center">{{ __('property_reports.tenant_name') }}</th>
                                        <th class="text-center">{{ __('property_reports.billing_month_year') }}</th>
                                ...
                                <tbody>
                                    @foreach ($units as $unit_item)
                                        @forelse ($unit_item->schedules  as $schedule)
                                            <tr style="background-color: red;color:white;">
                                                <th scope="row"><input class="check_bulk_item" name="bulk_ids[]"
                                                        type="checkbox" value="{{ $unit_item->id }}" />
                                                    {{ $loop->parent->index + 1 }}
                                                </th>
                                                ...
                                                <td class="text-center">
                                                    {{ $unit_item->unit_description?->name }}
                                                </td>
                                                <td class="text-center">
                                                    {{ $schedule->tenant?->name ?? $schedule->tenant?->company_name }}
                                                </td>
                                                <td class="text-center">
                                                    {{ $schedule->billing_month_year ?? __('general.not_available') }}
                                                </td>
                                                <td class="text-center">
                                                    {{ $schedule->rent_mode ?? __('general.not_available') }}
                                                </td>
                                                <td class="text-center">
                                                    {{ $schedule->rent_amount ?? __('general.not_available') }}
                                                </td>
                                                <td class="text-center">

    ...
    <div class="content container-fluid">
        ...
        <div class="mb-3">
            <h2 class="h1 mb-0 d-flex gap-2">
                ...
                {{ ui_change('services' , 'property_master') }}
            </h2>
        </div>
        <!-- End Page Title -->
            ...
            <div class="col-md-12 mb-3">
                <div class="card">
                    <div class="card-header">
                        {{ ui_change('add_new_services' , 'property_master')  }}
                    </div>
                    <div class="card-body" style="text-align: {{ $lang === 'ar' ? 'right' : 'left' }};">
                        <form action="{{ route($route . '.store') }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="title-color" for="code">
                                        {{ ui_change('vat_amount' , 'property_master')  }}<span class="text-danger">  %</span>
                                ...
                                <thead class="thead-light thead-50 text-capitalize">
                                    <tr>
                                        ...
                                        <th class="text-center">{{ ui_change( $route . '_name' , 'property_master') }} </th>
                                            ...
                                            <th class="text-center">{{ ui_change('vat_amount' , 'property_master')  }} </th>

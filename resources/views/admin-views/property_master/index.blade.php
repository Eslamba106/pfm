            ...
            <div class="col-md-12 mb-3">
                <div class="card">
                    <div class="card-header">
                        {{  ui_change('add_new_' . $route , 'property_master')  }}
                    </div>
                                ...
                                <form action="{{ url()->current() }}" method="GET">
                                    <div class="input-group input-group-custom input-group-merge">
                                        ...
                                        <input id="datatableSearch_" type="search" name="search" class="form-control"
                                            placeholder="{{  ui_change('search_by_' . $route . '_name' , 'property_master') }}"
                            ...
                            <table id="datatable"
                                ...
                                <thead class="thead-light thead-50 text-capitalize">
                                    <tr>
                                        ...
                                        <th class="text-center">{{ ui_change($route . '_name' , 'property_master')   }} </th>
                                        @if ($code_status == 'yes')
                                            <th class="text-center">{{ ui_change($route . '_code' , 'property_master')   }} </th>
                                        @endif
                                        @if ($description == 'yes')
                                            <th class="text-center">{{ ui_change('description' , 'property_master')   }} </th>
                                        @endif
                                        @if ($department == 'yes')
                                            <th class="text-center">{{ ui_change('department' , 'property_master')   }} </th>
                                        @endif
                                        @if ($complaint_type == 'yes')
                                            <th class="text-center">{{ ui_change('complaint_type' , 'property_master')   }} </th>
                                        @endif
                                        @if ($route == 'unit_type')
                                            <th class="text-center">{{ ui_change('unit_descriptions' , 'property_master')   }} </th>
                                        @endif
                                        @if ($route == 'priority')
                                            <th class="text-center">{{ ui_change('time_frame' , 'property_master')   }} </th>
                                        @endif
                                ...
                                <tbody>
                                    ...
                                    @if ($description == 'yes')
                                        <td class="text-center">
                                            ...
                                            @if ($route == 'priority')
                                                <td class="text-center">
                                                    {{ $value->time ?? ui_change('not_available' , 'property_master') }} </td>
                                            @endif

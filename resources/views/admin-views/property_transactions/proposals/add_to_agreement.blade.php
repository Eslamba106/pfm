...
@section('title', ui_change('create_agreement', 'property_transaction'))
@php
    ...
    <div class="content container-fluid">
        ...
        <div class="mb-3">
            <h2 class="h1 mb-0 text-capitalize d-flex gap-2">
                ...
                {{ ui_change('create_agreement', 'property_transaction') }}
            </h2>
        </div>
        <!-- End Page Title -->
        ...
        <!-- Form -->
        <form class="product-form text-start" action="{{ route('proposal.store_to_agreement') }}" method="POST"
                        ...
                        <div class="col-md-12 col-lg-4 col-xl-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="agreement_date" name="agreement_date"
                                    class="form-control"
                                    value="{{ \Carbon\Carbon::parse($agreement->proposal_date)->format('d-m-Y') }}">
                            </div>
                        </div>
            ...
            <input type="hidden" name="proposal_id" value="{{ $agreement->id }}">
                            ...
                            <div class="form-group">
                                ...
                                <select class="js-select2-custom form-control" name="employee_id">
                                    ...
                                    <option value="{{ $employee_item->id }}"
                                        {{ $employee_item->id == $agreement->proposal_details->employee_id ? 'selected' : '' }}>
                            ...
                            <div class="form-group">
                                ...
                                <select class="js-select2-custom form-control" name="agent_id">
                                    ...
                                    <option value="{{ $agent_item->id }}"
                                        {{ $agent_item->id == $agreement->proposal_details->agent_id ? 'selected' : '' }}>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="decision_maker"
                                    value="{{ $agreement->proposal_details->decision_maker }}">
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="decision_maker_designation"
                                    value="{{ $agreement->proposal_details->decision_maker_designation }}">
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="current_office_location"
                                    value="{{ $agreement->proposal_details->current_office_location }}">
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="reason_of_relocation"
                                    value="{{ $agreement->proposal_details->reason_of_relocation }}">
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="budget_for_relocation_start"
                                    value="{{ $agreement->proposal_details->budget_for_relocation_start }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control mt-2" name="budget_for_relocation_end"
                                    value="{{ $agreement->proposal_details->budget_for_relocation_end }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="no_of_emp_staff_strength"
                                    value="{{ $agreement->proposal_details->no_of_emp_staff_strength }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="relocation_date" class="relocation_date form-control"
                                    value="{{ isset($agreement->proposal_details->relocation_date) ? \Carbon\Carbon::createFromFormat('Y-m-d', $agreement->proposal_details->relocation_date)->format('d/m/Y') : \Carbon\Carbon::now()->format('d/m/Y') }}"
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="period_from"
                                    ...
                                    class="period_from form-control main_date" placeholder="DD/MM/YYYY"
                                    value="{{ isset($agreement->proposal_details->period_from) ? \Carbon\Carbon::createFromFormat('Y-m-d', $agreement->proposal_details->period_from)->format('d/m/Y') : \Carbon\Carbon::now()->format('d/m/Y') }}">
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4 col-xl-4">
                            <div class="form-group">
                                <label for="price" class="title-color"> </label>
                                <input type="text" name="period_to" class="period_to form-control mt-2 main_date"
                                    placeholder="DD/MM/YYYY"
                                    value="{{ isset($agreement->proposal_details->period_to) ? \Carbon\Carbon::createFromFormat('Y-m-d', $agreement->proposal_details->period_to)->format('d/m/Y') : \Carbon\Carbon::now()->addYear()->subDay()->format('d/m/Y') }}">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div id="main-content">
                @php
                    $unitCount = count($agreement_units);
                @endphp
                        ...
                        <div class="card-body mt-3">
                            ...
                            <div class="form-container mt-3">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div style="display: flex; gap: 10px;">
                                                <input type="text" name="period_from-{{ $item->id }}"
                                                    ...
                                                    id="period-from"
                                                    class="form-control all_dates text-white general_period_date"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div style="display: flex; gap: 10px;">
                                                <input type="text" name="period_to-{{ $item->id }}"
                                                    id="period-to"
                                                    class="form-control mt-2 all_dates text-white general_period_date_to"
                                ...
                                @php
                                    ...
                                    $unit_services_count =
                                        App\Models\ProposalUnitsService::where(
                                            'proposal_unit_id',
                                            $item->id,
                                        )->count() ?? 0;
                                @endphp
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="area-measurement" name="unit-{{ $item->id }}"
                                                ...
                                                <option value="{{ $item->unit_id }}">
                                                    {{ $unit->unit_management_main->name }}</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-lg-4 col-xl-3">
                                    ...
                                    <div class="col-md-6 col-lg-4 col-xl-3">
                                        <div class="form-group">
                                            ...
                                            <select id="area-measurement"
                                                ...
                                                <option value="2">Based on area</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-lg-4 col-xl-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="rent_amount-{{ $item->id }}"
                                                ...
                                                value="{{ number_format($item->rent_amount, $company->decimals, '.', '') }}">
                                        </div>
                                    </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="is_rent_inclusive_of_ewa-{{ $item->id }}"
                                                    ...
                                                    <option value="yes"
                                                        ...
                                                        {{ ui_change('yes', 'property_transaction') }}</option>
                                                    <option value="no"
                                                        {{ $item->is_rent_inclusive_of_ewa == 'no' ? 'selected' : '' }}>
                                                        {{ ui_change('no', 'property_transaction') }}</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-lg-4 col-xl-3">

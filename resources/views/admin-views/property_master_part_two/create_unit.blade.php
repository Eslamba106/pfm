                    ...
                    <div class="card-body" style="text-align: {{ $lang === 'ar' ? 'right' : 'left' }};">
                        {{-- <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 unit_form single-form" id="single-form">
                                    <form action="{{ route('unit.unit_single') }}" method="post">
                                        @csrf
                                        @include('includes.property_master.unit_single')
                                    </form>
                                </div>
                                <div class="col-md-12 unit_form d-none multiple-form" id="multiple-form">
                                    <form action="{{ route('unit.unit_multiple') }}" method="get">
                                        @csrf
                                        @include('includes.property_master.unit_multiple')
                                    </form>
                                </div>
                            </div>

    ...
    <div class="col-md-12">
        <div class="card">
                        ...
                        <form action="{{ url()->current() }}" method="GET">
                            <div class="input-group input-group-custom input-group-merge">
                                ...
                                <input id="datatableSearch_" type="search" name="search" class="form-control"
                                    placeholder="{{ ui_change('search_by_unit_name' , 'property_master') }}" aria-label="Search"
                                    value="{{ $search }}" required>
                                <button type="submit" class="btn btn--primary">{{ ui_change('general.search' , 'property_master') }}</button>
                            </div>
                        </form>
                        <!-- End Search -->
                    </div>
            ...
            <div class="position-relative px-3 py-4 m-2 ">
                <a class="btn btn--primary position-absolute" style="top: 10px; right: 10px;" href="{{ route('unit.create') }}">
                        ...
                        <tbody>
                            @foreach ($main as $key => $value)
                                <tr>
                                    ...
                                    @else
                                        <td class="text-center text-red "  style="color: red">{{ ui_change('not_available' , 'property_master') }}</td>
                                    @endif
                                    @if (isset($value->code))

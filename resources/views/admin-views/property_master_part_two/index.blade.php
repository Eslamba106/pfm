...
@endphp
@section('title', ui_change('floors' , 'property_master' ))
@push('css_or_js')
    ...
    <div class="content container-fluid">
        ...
        <div class="mb-3">
            <h2 class="h1 mb-0 d-flex gap-2">
                {{-- <img width="60" src="{{ asset('/assets/back-end/img/floor.jpg') }}" alt=""> --}}
                {{ ui_change('floors' , 'property_master' ) }}
            </h2>
        </div>
        <!-- End Page Title -->
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="px-3 py-4">
                    <div class="row align-items-center">
                        <div class="col-sm-4 col-md-6 col-lg-8 mb-2 mb-sm-0">
                            <h5 class="mb-0 d-flex align-items-center gap-2">{{ ui_change('floor_list' , 'property_master') }}
                            ...
                            <form action="{{ url()->current() }}" method="GET">
                                <div class="input-group input-group-custom input-group-merge">
                                    ...
                                    <input id="datatableSearch_" type="search" name="search" class="form-control"
                                        placeholder="{{ ui_change('search_by_floor_name' , 'property_master') }}" aria-label="Search"
                ...
                <div class="position-relative px-3 py-4 m-2 ">
                    <a class="btn btn--primary position-absolute" style="top: 10px; right: 10px;" href="{{ route('floor.create') }}">
                        ...
                        <table id="datatable"
                            ...
                            <thead class="thead-light thead-50 text-capitalize">
                                <tr>
                                    ...
                                    <th class="text-center">{{ ui_change('floor_name' , 'property_master') }} </th>
                                    <th class="text-center">{{ ui_change('floor_code' , 'property_master') }} </th>
                                    {{-- <th class="text-center">{{ ui_change('property_master.no_of_floor' , 'property_master') }} </th> --}}
                                    ...
                                    <tr>
                                        ...
                                        @else
                                            <td class="text-center text-red " style="color: red">
                                                {{ ui_change('not_available' , 'property_master') }}</td>
                                        @endif
                                        {{-- @if (isset($value->floor_no))
                                            <td class="text-center">{{ $value->floor_no }} </td>
                                        @else
                                            <td class="text-center text-red " style="color: red">
                                                {{ ui_change('general.not_available' , 'property_master') }}</td>
                                        @endif --}}
                                        @if (isset($value->code))

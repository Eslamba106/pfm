...
@section('title', ui_change('edit_unit' , 'property_master'))
@php
    ...
    <div class="content container-fluid">
        ...
        <div class="d-flex flex-wrap gap-2 align-items-center mb-3">
            <h2 class="h1 mb-0 d-flex align-items-center gap-2">
                {{-- <img width="50" src="{{ asset('/assets/back-end/img/units.png') }}" alt=""> --}}
                {{ ui_change('edit_unit' , 'property_master') }}
            </h2>
        </div>
        <div class="row">
            <div class="col-md-12">
                            ...
                            <div class="col-md-12 unit_form  multiple-form" id="multiple-form">
                                <form action="{{ route('unit.unit_multiple_edit' , $main->id) }}" method="post">
                                    ...
                                    <div class="form-group">
                                        <label for="name"
                                            class="title-color">{{ ui_change('unit_no_prefill_with_zero' , 'property_master') }}
                                        </label>
                                    ...
                                    <div class="form-group">
                                        <label for="name"
                                            class="title-color">{{ ui_change('unit_name_prefix' , 'property_master') }}
                                        </label>
                                        <input type="radio" name="unit_name_prefix_status" id="active"
                                            class="mr-3 ml-3 prefix_link_name"  @if(isset($main->name)) checked @endif>
                                        <label class="title-color" for="status">
                                            {{ ui_change('yes' , 'property_master') }}
                                        </label>
                                        <input type="radio" name="unit_name_prefix_status" id="inactive"
                                            class="mr-3 ml-3 prefix_link_name" @if(!isset($main->name)) checked @endif>
                                        <label class="title-color" for="status">
                                            {{ ui_change('no' , 'property_master') }}
                                        </label>
                                        <input type="text" name="unit_name_prefix" id="prefix_input_name"
                                            class="prefix_input form-control " value="{{ $main->name }}">
                                    </div>
                                    <div class="form-group">
                                        <label for="name"
                                            class="title-color">{{ ui_change('unit_code_prefix' , 'property_master') }}
                                        </label>

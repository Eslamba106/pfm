...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="container-fluid">
            ...
            <!-- Start Page Content -->
            <!-- ============================================================== -->
            <form id="signature-form" action="{{ route('user_management.update' , $user->id) }}" method="post"
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="js-select2-custom form-control" name="phone_dail_code" required>
                                        ...
                                        @foreach ($dail_code_main as $item_dail_code)
                                            <option value="{{ '+' . $item_dail_code->dial_code }}" @selected((  $user->phone_dail_code) == (  $item_dail_code->dial_code))>
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                ...
                                <div class="form-group input-group input-group-merge">
                                    ...
                                    <input type="password" class="js-toggle-password form-control" name="password" required
                                        id="signupSrPassword" placeholder="{{ __('8+_characters_required') }}"  value="{{ $user->my_name }}"

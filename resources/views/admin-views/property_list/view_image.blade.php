...
@endphp
@section('title', __('general.view_image'))
@push('css_or_js')
                            ...
                            @foreach ($property_item->blocks_management_child as $block_item)
                                ...
                                @foreach ($block_item->floors_management_child as $floor_item)
                                    <div class="grid">
                                        ...
                                        {{-- @foreach ($floor_item->unit_management_child as $unit_item)
                                            <div
                                                class=" hover-info unit  @if ($unit_item->booking_status == 'empty') empty
                                         ...
                                         @elseif($unit_item->booking_status == 'enquiry') enquiry @endif">

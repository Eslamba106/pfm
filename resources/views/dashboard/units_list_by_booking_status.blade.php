...
@section('title')
    {{ ui_change('Unit_List', 'property_transaction') }}
@endsection
@push('css_or_js')
...
@php
    ...
    $company = (new App\Models\Company())->setConnection('tenant')->select('decimals', 'currency_code')->first();
@endphp
                                                ...
                                                <td width="50">
                                                    @if ($unit->booking_status == 'enquiry')
                                                        ...
                                                        <div class="unit-tooltip" style="text-align: left;">
                                                            ...
                                                            @if ($enquiry_setting && $enquiry_main)
                                                                <br>{{ ui_change('Expaired_Date', 'property_transaction') }}
                                                                :
                                                                {{ \Carbon\Carbon::parse($enquiry_main->created_at)->addDays($enquiry_setting)->format('Y-F-d') }}
                                                            @endif
                                                    ...
                                                    @elseif ($unit->booking_status == 'proposal')
                                                        <div class="unit-tooltip text-start" style="text-align: left;">
                                                            ...
                                                            @if ($proposal_setting && $proposal_main)
                                                                <br>{{ ui_change('Expaired_Date', 'property_transaction') }}
                                                                :
                                                                {{ \Carbon\Carbon::parse($proposal_main->created_at)->addDays($proposal_setting)->format('Y-F-d') }}
                                                            @endif
                                                        </div>
                                                    @elseif ($unit->booking_status == 'booking')
                                                        <div class="unit-tooltip" style="text-align: left;">
                                                            ...
                                                            @if ($booking_setting && $booking_main)
                                                                <br>{{ ui_change('Expaired_Date', 'property_transaction') }}
                                                                :
                                                                {{ \Carbon\Carbon::parse($booking_main->created_at)->addDays($booking_setting)->format('Y-F-d') }}
                                                            @endif
                                                        </div>
                                                    @elseif ($unit->booking_status == 'agreement')
                                                        <div class="unit-tooltip" style="text-align: left;">
                                                            ...
                                                            @if ($agreement_setting && $agreement_main)
                                                                <br>{{ ui_change('Expaired_Date', 'property_transaction') }}
                                                                :
                                                                {{ \Carbon\Carbon::parse($agreement_main->created_at)->addDays($agreement_setting)->format('Y-F-d') }}
                                                            @endif
                                                        </div>
                                                    @endif
                ...
                <div class="table-responsive">
                    <table class="table table-bordered align-middle mb-0">
                        <thead class="bg-light text-center">
                            <tr>
                                <th style="width: 40%; font-weight:600;">{{ ui_change('Field', 'property_report') }}</th>

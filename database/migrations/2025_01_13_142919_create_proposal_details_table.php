...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('proposal_details', function (Blueprint $table) {
            ...
            $table->foreignId('proposal_status_id')->nullable()->constrained('enquiry_statuses')->cascadeOnDelete();
            $table->foreignId('proposal_request_status_id')->nullable()->constrained('enquiry_request_statuses')->cascadeOnDelete();

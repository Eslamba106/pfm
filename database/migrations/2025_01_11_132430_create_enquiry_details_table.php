...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('enquiry_details', function (Blueprint $table) {
            ...
            $table->foreignId('enquiry_status_id')->nullable()->constrained('enquiry_statuses')->cascadeOnDelete();
            $table->foreignId('enquiry_request_status_id')->nullable()->constrained('enquiry_request_statuses')->cascadeOnDelete();

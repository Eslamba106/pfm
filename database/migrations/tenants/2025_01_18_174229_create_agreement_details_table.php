...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('agreement_details', function (Blueprint $table) {
            ...
            $table->foreignId('agreement_status_id')->nullable()->constrained('enquiry_statuses')->cascadeOnDelete();
            $table->foreignId('agreement_request_status_id')->nullable()->constrained('enquiry_request_statuses')->cascadeOnDelete();
